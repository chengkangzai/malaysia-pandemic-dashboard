...
use App\Filament\Resources\TestMalaysiaResource\Pages;
...
class TestMalaysiaResource extends Resource
{
    protected static ?string $model = TestMalaysia::class;

    protected static ?string $navigationIcon = 'heroicon-o-check';

    protected static ?string $navigationGroup = 'Tests';

    protected static ?string $label = 'National Test';
    ...
    {
        return [
            'index' => Pages\ManageTestMalaysias::route('/'),
        ];
    }
}
