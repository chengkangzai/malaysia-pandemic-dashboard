...
class ImportPandemicService
{
        ...
        return $content
            ->map(function ($record) {
                ...
                return [
                    ...
                    'cumul_booster2' => $this->takeIndex($vax, $i++), // change in index
                    'cumul' => $this->takeIndex($vax, $i++),
                    'cumul_partial_adol' => $this->takeIndex($vax, $i++),
                    'cumul_full_adol' => $this->takeIndex($vax, $i++),
                    'cumul_booster_adol' => $this->takeIndex($vax, $i++),
    ...
    private function formatVaxReg(array $array): array
    {
        ...
        return [
            ...
            'children_solo' => $this->takeIndex($array, $i++),
            'adolescents' => $this->takeIndex($array, $i++),
