                ...
                <table class="min-w-full divide-y divide-gray-200">
                    ...
                    <tr>
                        <th colspan="5" class="border-b py-2">
                            <div class="h-6 w-48 bg-gray-400 rounded mx-auto"></div>
                            <div class="mt-2 h-4 w-32 bg-gray-400 rounded float-right"></div>
                        </th>
                    </tr>
                    <tr>
                        @foreach (range(1, 5) as $_)
                            <th scope="col" class="py-4 text-center">
                                <div class="h-4 w-32 bg-gray-400 rounded mx-auto"></div>
                            </th>
                        @endforeach
                    </tr>
                    </thead>
                        ...
                        <tr class="@if ($loop->even) bg-gray-50 @endif">
                            @foreach (range(1, 5) as $_)
                                <td class="whitespace-nowrap px-6 py-4">
                                    <div class="h-3 w-24 bg-gray-400 rounded mx-auto"></div>
                                </td>
                            @endforeach
                        </tr>
                    @endforeach
                    <tr>
                        @foreach (range(1, 5) as $_)
                            <td class="whitespace-nowrap px-6 py-4">
                                <div class="h-4 w-24 bg-gray-400 rounded mx-auto"></div>
                            </td>
                        @endforeach
                    </tr>
                    </tbody>
                    ...
                    <tr class="bg-white">
                        <td class="whitespace-nowrap px-6 py-4 text-left" colspan="5">
                            <div class="h-4 w-64 bg-gray-400 rounded mx-auto"></div>
                        </td>
                    </tr>
                    </tfoot>
                </table>
